...
class CreateUser extends Component {
    ...
    handleClick() {
        ...
        if (roles.length === 0){
            ...
            alert("Entered name: " + this.state.name
                + "\nEntered password: " + this.state.password
                + "\nConfirmed pass: " + this.state.confirmPassword
        ...
        return (
            <div style={styles.container}>
                ...
                <form style={styles.form}>
                    ...
                    <label htmlFor="email" style={styles.label}>Confirm password</label>
                    <input
                        type="password"
                    ...
                    <label htmlFor="roles" style={styles.label}>Choose user role(s)</label>
                    <div className="checkBoxes">
                        <input type="checkbox" value="Coordinator" name="coordinator" onChange={this.onCheckboxChange}/>Coordinator<br/>
                        <input type="checkbox" value="Student" name="student" onChange={this.onCheckboxChange}/>Student<br/>
                        <input type="checkbox" value="Reader" name="reader" onChange={this.onCheckboxChange}/>Reader<br/>
                        <input type="checkbox" value="Supervisor" name="supervisor" onChange={this.onCheckboxChange}/>Supervisor<br/>
                        <input type="checkbox" value="Opponent" name="opponent" onChange={this.onCheckboxChange}/>Opponent<br/>
                    </div>
